	...
	public class apSelection
	{
		...
		private void Draw_ImageRes(int width, int height)
		{
			...
			if (_imageImporter != null)
			{
				...
				if (_imageImporter.isReadable)
				{
					...
					GUILayout.Box(Editor.GetUIWord(UIWORD.WarningTextureRWNeedToDisabledForOpt), apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(48));
			...
			//변경
			if (GUILayout.Button(_guiContent_Image_RemoveImage.Content, GUILayout.Height(24)))//"  Remove Image"
			{
		...
		private void Draw_Animation(int width, int height)
		{
			...
			if (_animClip._targetMeshGroup == null)
			{
				...
				//" Select MeshGroup"
				if (GUILayout.Button(_guiContent_Animation_SelectMeshGroupBtn.Content, GUILayout.Width(width), GUILayout.Height(35)))
				{
			...
			else
			{
				...
				GUILayout.Box(strMeshGroupName, apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width - (80 + 2)), GUILayout.Height(18));
				GUI.backgroundColor = prevColor;
				...
				if(!isValidMeshGroup)
				{
					...
					GUILayout.Box(Editor.GetUIWord(UIWORD.AnimLinkedToInvalidMeshGroup), apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(20));
				...
				if (GUILayout.Button(_guiContent_Animation_AddTimeline.Content, GUILayout.Width(width), GUILayout.Height(30)))
				{
				...
				GUILayout.Button("", apGUIStyleWrapper.I.None, GUILayout.Width(20), GUILayout.Height(20));//<레이아웃 정렬을 위한의미없는 숨은 버튼
				EditorGUILayout.EndHorizontal();
			...
			if (GUILayout.Button(_guiContent_Animation_RemoveAnimation.Content, GUILayout.Height(24)))
			{
		...
		private void DrawTimelineUnit(apAnimTimeline timeline, int width, int height)
		{
			...
			if (GUILayout.Button(curGUIContentWrapper.Content, curGUIStyle, GUILayout.Width(width - 40), GUILayout.Height(height)))
			{
			...
			if (GUILayout.Button(activeBtn, curGUIStyle, GUILayout.Width(height), GUILayout.Height(height)))
			{
				//일단 토글한다.
		...
		private void Draw_Overall(int width, int height)
		{
			...
			if (Editor._rootUnitEditMode == apEditor.ROOTUNIT_EDIT_MODE.Setting)
			{
				...
				GUILayout.Box(strMeshGroupName, apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(35));
					...
					case apEditor.ROOTUNIT_CAPTURE_MODE.Thumbnail:
						{
							...
							//썸네일 만들기 버튼
							if (GUILayout.Button(_guiContent_Overall_MakeThumbnail.Content, GUILayout.Width(width), GUILayout.Height(30)))
							{
					...
					case apEditor.ROOTUNIT_CAPTURE_MODE.ScreenShot:
						{
							...
							if (GUILayout.Button(_guiContent_Overall_TakeAScreenshot.Content, GUILayout.Width(width), GUILayout.Height(30)))
							{
					...
					case apEditor.ROOTUNIT_CAPTURE_MODE.GIFAnimation:
						{
							...
							GUILayout.Box(animName, apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(30));
							...
							try
							{
								...
								else
								{
									...
									if (isDrawGIFAnimClips)
									{
										...
										if (GUILayout.Button("Set", apGUIStyleWrapper.I.Button_TextFieldMargin, GUILayout.Width(30), GUILayout.Height(18)))
										{
										...
										//"Animation Clips"
										GUILayout.Button("  " + _editor.GetText(TEXT.DLG_AnimationClips), apGUIStyleWrapper.I.None_LabelColor, GUILayout.Width(width), GUILayout.Height(20));//투명 버튼
										...
										if (subAnimClips.Count > 0)
										{
											...
											for (int i = 0; i < subAnimClips.Count; i++)
											{
												...
												if (GUILayout.Button(_guiContent_Overall_AnimItem.Content, curGUIStyle, GUILayout.Width(width - 35), GUILayout.Height(20)))
												{
							...
							try
							{
								...
								else
								{
									...
									if (isDrawSpritesheetSettings)
									{
										...
										GUILayout.Box(strNumOfSprites, apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(40));
										...
										if (subAnimClips.Count > 0)
										{
											...
											for (int i = 0; i < subAnimClips.Count; i++)
											{
												...
												if (GUILayout.Button(_guiContent_Overall_AnimItem.Content, apGUIStyleWrapper.I.None_LabelColor, GUILayout.Width((width - 35) - 35), GUILayout.Height(20)))
												{
													//nextSelectedAnimClip = animClip;
												}
		...
		private void Draw_Param(int width, int height)
		{
			...
			EditorGUILayout.LabelField(_guiContent_Param_IconPreset.Content, GUILayout.Width(iconSize), GUILayout.Height(iconPresetHeight));
			...
			if (GUILayout.Button(_guiContent_Param_Presets.Content, GUILayout.Height(30)))
			{
			...
			if (!cParam._isReserved)
			{
				...
				if (GUILayout.Button(_guiContent_Param_RemoveParam.Content, GUILayout.Height(24)))
				{
		...
		private void DrawTitle(string strTitle, int width, int height)
		{
			...
			GUILayout.Box(strTitle, apGUIStyleWrapper.I.Box_MiddleCenter_LabelMargin_WhiteColor, GUILayout.Width(titleWidth), GUILayout.Height(20));
		...
		private void DrawHowToControl(int width, string msgMouseLeft, string msgMouseMiddle, string msgMouseRight, string msgKeyboardDelete = null, string msgKeyboardCtrl = null, string msgKeyboardShift = null)
		{
			...
			if (isMouseLeft)
			{
				...
				EditorGUILayout.LabelField(_guiContent_MeshProperty_HowTo_MouseLeft.Content, apGUIStyleWrapper.I.Label_BoxMargin, GUILayout.Width(labelSize), GUILayout.Height(labelSize));
			...
			if (isMouseMiddle)
			{
				...
				EditorGUILayout.LabelField(_guiContent_MeshProperty_HowTo_MouseMiddle.Content, apGUIStyleWrapper.I.Label_BoxMargin, GUILayout.Width(labelSize), GUILayout.Height(labelSize));
			...
			if (isMouseRight)
			{
				...
				EditorGUILayout.LabelField(_guiContent_MeshProperty_HowTo_MouseRight.Content, apGUIStyleWrapper.I.Label_BoxMargin, GUILayout.Width(labelSize), GUILayout.Height(labelSize));
			...
			if (isKeyDelete)
			{
				...
				EditorGUILayout.LabelField(_guiContent_MeshProperty_HowTo_KeyDelete.Content, apGUIStyleWrapper.I.Label_BoxMargin, GUILayout.Width(labelSize), GUILayout.Height(labelSize));
			...
			if (isKeyCtrl)
			{
				...
				EditorGUILayout.LabelField(_guiContent_MeshProperty_HowTo_KeyCtrl.Content, apGUIStyleWrapper.I.Label_BoxMargin, GUILayout.Width(labelSize), GUILayout.Height(labelSize));
			...
			if (isKeyShift)
			{
				...
				EditorGUILayout.LabelField(_guiContent_MeshProperty_HowTo_KeyShift.Content, apGUIStyleWrapper.I.Label_BoxMargin, GUILayout.Width(labelSize), GUILayout.Height(labelSize));
		...
		private void MeshProperty_None(int width, int height)
		{
			...
			if (curTextureImage != null)
			{
				...
				EditorGUILayout.LabelField(_guiContent_MeshProperty_Texture.Content, GUILayout.Height(selectedImageHeight));
				GUILayout.Space(10);
			}
			else
			{
			...
			if (GUILayout.Button(_guiContent_MeshProperty_ChangeImage.Content, GUILayout.Height(30)))//"  Change Image"
			{
				//_isShowTextureDataList = !_isShowTextureDataList;
			...
			{
				_guiContent_MeshProperty_ResetVerts = apGUIContentWrapper.Make(Editor.GetUIWord(UIWORD.ResetVertices), false, "Remove all Vertices and Polygons");
			}
			...
			//변경
			if (GUILayout.Button(_guiContent_MeshProperty_RemoveMesh.Content, GUILayout.Height(24)))//"  Remove Mesh"
			{
		...
		private void MeshProperty_Modify(int width, int height)
		{
			...
			{
				_guiContent_MeshProperty_MakePolygones = apGUIContentWrapper.Make(Editor.GetUIWord(UIWORD.MakePolygons), Editor.ImageSet.Get(apImageSet.PRESET.MeshEdit_MakePolygon), "Make Polygons and Refresh Mesh");
			}
			if (GUILayout.Button(_guiContent_MeshProperty_MakePolygones.Content, GUILayout.Width(width), GUILayout.Height(40)))
			{
				//Undo
		...
		private void MeshProperty_MakeMesh(int width, int height)
		{
			...
			if (isSubTab_Add)
			{
				...
				GUILayout.Box(strMakeMeshModeInfo, apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width - 8), GUILayout.Height(34));
			...
			else
			{
				...
				EditorGUILayout.BeginHorizontal(GUILayout.Width(width), GUILayout.Height(25));
				GUILayout.Space(5);
				EditorGUILayout.LabelField(Mesh._isPSDParsed ? _guiContent_StepCompleted.Content : _guiContent_StepUncompleted.Content, apGUIStyleWrapper.I.Label_MiddleCenter, GUILayout.Width(width_StepIcon), GUILayout.Height(25));
				...
				if (Mesh._isPSDParsed)
				{
					...
					if (GUILayout.Button(_guiContent_imgValueUp.Content, apGUIStyleWrapper.I.Button_TextFieldMargin, GUILayout.Width(width_AreaChangeBtn), GUILayout.Height(18)))
					{
						//5씩 움직인다.
						apEditorUtil.SetRecord_Mesh(apUndoGroupData.ACTION.MeshEdit_AtlasChanged, Editor, Mesh, Mesh, false);
					...
					if (GUILayout.Button(_guiContent_imgValueDown.Content, apGUIStyleWrapper.I.Button_TextFieldMargin, GUILayout.Width(width_AreaChangeBtn), GUILayout.Height(18)))
					{
						apEditorUtil.SetRecord_Mesh(apUndoGroupData.ACTION.MeshEdit_AtlasChanged, Editor, Mesh, Mesh, false);
						Mesh._atlasFromPSD_LT.y -= 5;
						meshAtlas_Top = Mesh._atlasFromPSD_LT.y;
					...
					if (GUILayout.Button(_guiContent_imgValueLeft.Content, apGUIStyleWrapper.I.Button_TextFieldMargin, GUILayout.Width(width_AreaChangeBtn), GUILayout.Height(18)))
					{
						apEditorUtil.SetRecord_Mesh(apUndoGroupData.ACTION.MeshEdit_AtlasChanged, Editor, Mesh, Mesh, false);
					...
					if (GUILayout.Button(_guiContent_imgValueRight.Content, apGUIStyleWrapper.I.Button_TextFieldMargin, GUILayout.Width(width_AreaChangeBtn), GUILayout.Height(18)))
					{
						apEditorUtil.SetRecord_Mesh(apUndoGroupData.ACTION.MeshEdit_AtlasChanged, Editor, Mesh, Mesh, false);
						Mesh._atlasFromPSD_LT.x += 5;
						meshAtlas_Left = Mesh._atlasFromPSD_LT.x;
					...
					EditorGUILayout.LabelField(	isTextureReadWriteEnabled && isValidTexture ? (Editor.MeshGenerator.IsCompleted ? _guiContent_StepUnUsed.Content : _guiContent_StepCompleted.Content) : _guiContent_StepUncompleted.Content, 
												...
												GUILayout.Width(width_StepIcon), GUILayout.Height(25));
					...
					if (isScanWarning)
					{
						...
						GUI.backgroundColor = new Color(1.0f, 0.6f, 0.5f, 1.0f);
						GUILayout.Box(scanWarning, apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(32));
					...
					EditorGUILayout.LabelField(	isScanned && isScannable ? _guiContent_StepCompleted.Content : _guiContent_StepUncompleted.Content, 
												apGUIStyleWrapper.I.Label_MiddleCenter, GUILayout.Width(width_StepIcon), GUILayout.Height(30));
				...
				else
				{
					...
					GUI.backgroundColor = new Color(1.0f, 0.6f, 0.5f, 1.0f);
					GUILayout.Box(Editor.GetUIWord(UIWORD.WarningAreaDisabled), apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(32));//"Area Option is Disabled"
			...
			{
				_guiContent_MeshProperty_RemoveAllVertices = apGUIContentWrapper.Make(Editor.GetUIWord(UIWORD.RemoveAllVertices), Editor.ImageSet.Get(apImageSet.PRESET.Hierarchy_RemoveTransform), "Remove all Vertices and Polygons");
			}
			
			if (GUILayout.Button(_guiContent_MeshProperty_RemoveAllVertices.Content, GUILayout.Height(24)))
			{
		...
		private void DrawMakePolygonsTool(int width)
		{
			...
			{
				_guiContent_MeshProperty_Draw_MakePolygones = apGUIContentWrapper.Make(2, Editor.GetUIWord(UIWORD.MakePolygons), Editor.ImageSet.Get(apImageSet.PRESET.MeshEdit_MakePolygon), "Make Polygons and Refresh Mesh");
			}
			...
			//변경
			if (GUILayout.Button(_guiContent_MeshProperty_AutoLinkEdge.Content, GUILayout.Height(30)))
			{
				//Undo
				apEditorUtil.SetRecord_Mesh(apUndoGroupData.ACTION.MeshEdit_MakeEdges, Editor, Editor.Select.Mesh, Editor.Select.Mesh, false);
			...
			//변경
			if (GUILayout.Button(_guiContent_MeshProperty_Draw_MakePolygones.Content, GUILayout.Height(50)))
			{
				//Undo
				apEditorUtil.SetRecord_Mesh(apUndoGroupData.ACTION.MeshEdit_MakeEdges, Editor, Editor.Select.Mesh, Editor.Select.Mesh, false);
		...
		private void DrawMakeMeshMirrorTool(int width, bool isUseCopyTool, bool isUseSnapTool)
		{
			...
			float nextAxisValue = EditorGUILayout.DelayedFloatField(prevAxisValue, apGUIStyleWrapper.I.TextField_BtnMargin, GUILayout.Width(width_Value));
			if (Mathf.Abs(nextAxisValue - prevAxisValue) > 0.0001f)
			{
				apEditorUtil.SetRecord_Mesh(apUndoGroupData.ACTION.MeshEdit_SettingChanged, Editor, Mesh, Mesh, false);
				if (isMirrorX)
			...
			float nextMirrorCopyOffset = EditorGUILayout.DelayedFloatField(Editor._meshTRSOption_MirrorOffset, apGUIStyleWrapper.I.TextField_BtnMargin, GUILayout.Width(width_Value));
			if (Mathf.Abs(nextMirrorCopyOffset - Editor._meshTRSOption_MirrorOffset) > 0.0001f)
			{
				Editor._meshTRSOption_MirrorOffset = nextMirrorCopyOffset;
				Editor.SaveEditorPref();
		...
		private void MeshGroupProperty_Setting(int width, int height)
		{
			...
			if (isMainMeshGroup)
			{
				...
				//"Root Unit"
				GUILayout.Box(Editor.GetUIWord(UIWORD.RootUnit), apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(30));
			...
			else
			{
				...
				{
					_guiContent_MeshGroupProperty_SetRootUnit = apGUIContentWrapper.Make(1, Editor.GetUIWord(UIWORD.SetRootUnit), Editor.ImageSet.Get(apImageSet.PRESET.Hierarchy_Root), "Make Mesh Group as Root Unit");
				}
				
				if (GUILayout.Button(_guiContent_MeshGroupProperty_SetRootUnit.Content, GUILayout.Width(width), GUILayout.Height(30)))
				{
			...
			if (GUILayout.Button(_guiContent_MeshGroupProperty_RemoveMeshGroup.Content, GUILayout.Height(24)))
			{
		...
		private void MeshGroupProperty_Bone(int width, int height)
		{
			...
			if (isBoneEditable)
			{
				...
				GUILayout.Box(strBoneEditInfo, apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width - 8), GUILayout.Height(34));
			...
			if (GUILayout.Button(_guiContent_MeshGroupProperty_RemoveAllBones.Content, GUILayout.Width(width), GUILayout.Height(24)))
			{
		...
		private void MeshGroupProperty_Modify(int width, int height)
		{
			...
			{
				_guiContent_MeshGroupProperty_AddModifier = apGUIContentWrapper.Make(2, Editor.GetUIWord(UIWORD.AddModifier), Editor.ImageSet.Get(apImageSet.PRESET.Modifier_AddNewMod), "Add a New Modifier");
			}
			
			if (GUILayout.Button(_guiContent_MeshGroupProperty_AddModifier.Content, GUILayout.Height(30)))
			{
		...
		private int DrawModifierLayerUnit(apModifierBase modifier, int width, int height)
		{
			...
			if (GUILayout.Button(_guiContent_MeshGroupProperty_ModifierLayerUnit.Content, curGUIStyle, GUILayout.Width(width - 40), GUILayout.Height(height)))
			{
				SetModifier(modifier);
			}
		...
		public void DrawEditor_Bottom2Edit(int width, int height)
		{
				...
				case EX_EDIT_KEY_VALUE.ParamKey_ModMesh://ModVert와 ModMesh는 비슷하다
					{
						...
						EditorGUILayout.LabelField(_guiContent_Bottom_EditMode_CommonIcon.Content, GUILayout.Width(height), GUILayout.Height(height));
			...
			else if (Modifier.ModifierType == apModifierBase.MODIFIER_TYPE.Physic)
			{
				...
				{
					_guiContent_Bottom2_Physic_WindON = apGUIContentWrapper.Make(Editor.GetUIWord(UIWORD.PxWindOn), false, "Simulate wind forces");
				}

				if(_guiContent_Bottom2_Physic_WindOFF == null)
				{
					_guiContent_Bottom2_Physic_WindOFF = apGUIContentWrapper.Make(Editor.GetUIWord(UIWORD.PxWindOff), false, "Clear wind forces");
				}

				if (GUILayout.Button(_guiContent_Bottom2_Physic_WindON.Content, GUILayout.Width(110), GUILayout.Height(height)))
				{
					GUI.FocusControl(null);
				...
				//"Wind Off"
				if (GUILayout.Button(_guiContent_Bottom2_Physic_WindOFF.Content, GUILayout.Width(110), GUILayout.Height(height)))
				{
					GUI.FocusControl(null);
					if (_portrait != null)
					{
		...
		private void DrawEditor_Bottom_Animation(int width, int height, int layoutX, int layoutY, int windowWidth, int windowHeight)
		{
			...
			if (apEditorUtil.ToggledButton_2Side_LeftAlign(editIcon, strButtonName, strButtonName, ExAnimEditingMode != EX_EDIT.None, isEditable, 105, animEditBtnGroupHeight, "Animation Edit Mode (A)"))
			{
			...
			for (int iLayer = 0; iLayer < timelineInfoList.Count; iLayer++)
			{
				...
				if (info._isRenderable)
				{
					...
					else
					{
						...
						if (GUI.Button(new Rect(2, (curLayerY + yOffset) - _scroll_Timeline.y, 18, 18), "-", apGUIStyleWrapper.I.Button_Margin0))
						{
							//Hide
			...
			if (GUILayout.Button(_guiContent_Bottom_Animation_FirstFrame.Content, GUILayout.Width(ctrlBtnSize_Large), GUILayout.Height(ctrlBtnSize_Large)))
			{
				//제어 : 첫 프레임으로 이동
			...
			if (GUILayout.Button(_guiContent_Bottom_Animation_PrevFrame.Content, GUILayout.Width(ctrlBtnSize_Large + 10), GUILayout.Height(ctrlBtnSize_Large)))
			{
				//제어 : 이전 프레임으로 이동
			...
			if (GUILayout.Button(curPlayPauseGUIContent.Content, GUILayout.Width(ctrlBtnSize_Large + 30), GUILayout.Height(ctrlBtnSize_Large)))
			{
				//제어 : 플레이 / 일시정지
				if (AnimClip.IsPlaying_Editor)
				{
			...
			if (GUILayout.Button(_guiContent_Bottom_Animation_NextFrame.Content, GUILayout.Width(ctrlBtnSize_Large + 10), GUILayout.Height(ctrlBtnSize_Large)))
			{
				//제어 : 다음 프레임으로 이동
			...
			if (GUILayout.Button(_guiContent_Bottom_Animation_LastFrame.Content, GUILayout.Width(ctrlBtnSize_Large), GUILayout.Height(ctrlBtnSize_Large)))
			{
				//제어 : 마지막 프레임으로 이동
			...
			{
				_guiContent_Bottom_Animation_Fit = apGUIContentWrapper.Make(" Fit", Editor.ImageSet.Get(apImageSet.PRESET.Anim_AutoZoom), "Zoom to fit the animation length");
			}
			
			if (GUILayout.Button(_guiContent_Bottom_Animation_Fit.Content, GUILayout.Width(80), GUILayout.Height(ctrlBtnSize_Small)))
			{
			...
			GUILayout.Box(propertyTitle, apGUIStyleWrapper.I.Box_MiddleCenter_WhiteColor, GUILayout.Width(rightPropertyWidth), GUILayout.Height(20));
			GUI.backgroundColor = prevColor;
			...
			if (_animPropertyUI == ANIM_SINGLE_PROPERTY_UI.Value)
			{
						...
						case apControlParam.TYPE.Int:
							{
								...
								EditorGUILayout.BeginHorizontal(GUILayout.Width(width));
								EditorGUILayout.LabelField(controlParam._label_Min, apGUIStyleWrapper.I.Label_MiddleLeft, GUILayout.Width(widthLabelRange));
								EditorGUILayout.LabelField(controlParam._label_Max, apGUIStyleWrapper.I.Label_MiddleRight, GUILayout.Width(widthLabelRange));
								EditorGUILayout.EndHorizontal();
				...
				if (isDrawModifierUI && isSameKP)
				{
					...
					if (isMod_TF)
					{
						...
						EditorGUILayout.LabelField(_guiContent_Icon_ModTF_Pos.Content, GUILayout.Width(iconSize), GUILayout.Height(iconSize));
						...
						EditorGUILayout.LabelField(_guiContent_Icon_ModTF_Rot.Content, GUILayout.Width(iconSize), GUILayout.Height(iconSize));
						...
						EditorGUILayout.LabelField(_guiContent_Icon_ModTF_Scale.Content, GUILayout.Width(iconSize), GUILayout.Height(iconSize));
					...
					if (isMod_Color)
					{
						...
						if (linkedModifier._isColorPropertyEnabled)
						{
							...
							EditorGUILayout.LabelField(_guiContent_Icon_Mod_Color.Content, GUILayout.Width(iconSize), GUILayout.Height(iconSize));
		...
		private void DrawEditor_Bottom_AnimationProperty_MultipleKeyframes(List<apAnimKeyframe> keyframes, int width, int windowWidth, int windowHeight, int layoutX, int layoutY, int scrollValue)
		{
			...
			if (Editor.IsDelayedGUIVisible(apEditor.DELAYED_UI_TYPE.AnimProperty_MultipleCurve__Sync))//"AnimProperty_MultipleCurve : Sync"
			{
			...
			if (GUILayout.Button(_guiContent_Bottom_Animation_RemoveNumKeyframes.Content, GUILayout.Width(width), GUILayout.Height(24)))
			{
		...
		private void DrawEditor_Bottom_AnimationProperty_TimelineLayer(apAnimTimelineLayer timelineLayer, int width)
		{
				...
				)
			{
				...
				GUILayout.Box(timelineLayer.DisplayName, apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(30));
		...
		private void DrawEditor_Bottom_AnimationProperty_Timeline(apAnimTimeline timeline, int width)
		{
				...
				)
			{
				...
				GUILayout.Box(timeline.DisplayName, apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(30));
		...
		private void DrawEditor_Right2_MeshGroup_Setting(int width, int height)
		{
			...
			if (isSelectedObjectRender)
			{
				...
				if (isMeshTransform)
				{
					...
					EditorGUILayout.LabelField(_guiContent_Right_MeshGroup_MeshIcon.Content, GUILayout.Width(50), GUILayout.Height(50));
				}
				else
				{
					...
					EditorGUILayout.LabelField(_guiContent_Right_MeshGroup_MeshGroupIcon.Content, GUILayout.Width(50), GUILayout.Height(50));
				}
				...
				if (isMeshTransform && isMeshTransformDetailRendererable)
				{
					...
					if (!isCustomShader)
					{
						...
						//변경
						GUILayout.Box(_guiContent_Right_MeshGroup_MaterialSet.Content, apGUIStyleWrapper.I.Box_MiddleCenter, GUILayout.Width(width), GUILayout.Height(30));
					}
					else
					{
					...
					if(isDraw_MaterialLibrary)
					{
						...
						if(!SubMeshInGroup._isUseDefaultMaterialSet && isDraw_MatLib_NotUseDefault)
						{
							...
							if (SubMeshInGroup._linkedMaterialSet != null)
							{
								...
								GUILayout.Box(_guiContent_Right_MeshGroup_MatSetName.Content, apGUIStyleWrapper.I.Box_MiddleCenter, GUILayout.Width(width), GUILayout.Height(30));
							}
							else
							{
								//붉은색으로 표시
								...
								GUILayout.Box(Editor.GetUIWord(UIWORD.None), apGUIStyleWrapper.I.Box_MiddleCenter, GUILayout.Width(width), GUILayout.Height(30));
								GUI.backgroundColor = prevColor;
							}
					...
					if (isSameMeshTF)//출력 가능한 경우
					{
						for (int iMatProp = 0; iMatProp < cutomMatProps.Count; iMatProp++)
						{
							...
							GUILayout.Space(5);
							if (GUILayout.Button("X", apGUIStyleWrapper.I.Button_TextFieldMargin, GUILayout.Width(18), GUILayout.Height(18)))
							{
								//삭제
					...
					if (GUILayout.Button(_guiContent_Right_MeshGroup_CopySettingToOtherMeshes.Content, GUILayout.Height(24)))
					{
					...
					if (SubMeshInGroup._isClipping_Parent)
					{
						if (Editor.IsDelayedGUIVisible(apEditor.DELAYED_UI_TYPE.Mesh_Transform_Detail_Status__Clipping_Parent))//"Mesh Transform Detail Status - Clipping Parent"
						{
							...
							//"Parent Mask Mesh"
							GUILayout.Box(Editor.GetUIWord(UIWORD.ParentMaskMesh), apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(25));
							GUILayout.Space(5);
					...
					else if (SubMeshInGroup._isClipping_Child)
					{
						if (Editor.IsDelayedGUIVisible(apEditor.DELAYED_UI_TYPE.Mesh_Transform_Detail_Status__Clipping_Child))//"Mesh Transform Detail Status - Clipping Child"
						{
							...
							GUILayout.Box(Editor.GetUIWord(UIWORD.ClippedChildMesh), apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(25));
							GUILayout.Space(5);
		...
		private void DrawEditor_Right2_MeshGroup_Bone(int width, int height)
		{
			...
			EditorGUILayout.LabelField(_guiContent_Right_MeshGroup_ModIcon.Content, GUILayout.Width(50), GUILayout.Height(50));
...
#region [미사용 코드] DelayedTextField 사용 전 코드
			...
			GUILayout.Box(strIKInfo, apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(40));
			...
			EditorGUILayout.LabelField(_guiContent_Right_MeshGroup_RiggingIconAndText.Content, GUILayout.Width(width));
...
#region [미사용 코드]
			...
			if (curBone._IKController._controllerType != apBoneIKController.CONTROLLER_TYPE.None)
			{
				...
				EditorGUILayout.LabelField(_guiContent_Right_MeshGroup_RiggingIconAndText.Content, GUILayout.Width(width - 60));
				...
				if (curBone._IKController._isWeightByControlParam)
				{
					...
					EditorGUILayout.LabelField(_guiContent_Right_MeshGroup_ParamIconAndText.Content, GUILayout.Width(width - 60));
			...
			if (GUILayout.Button(_guiContent_Right_MeshGroup_RemoveBone.Content, GUILayout.Width(width), GUILayout.Height(24)))
			{
				isAnyGUIAction = true;
				SetBoneEditMode(BONE_EDIT_MODE.SelectAndTRS, true);
		...
		private void DrawEditor_Right2_MeshGroup_Modifier(int width, int height)
		{
			...
			if (GUILayout.Button(	_guiContent_Right_MeshGroup_RemoveModifier.Content, GUILayout.Height(24)))
			{
...
#region [미사용 코드]
		...
		private void DrawModifierPropertyGUI_ControllerParamSet(int width, int height, apDialog_SelectControlParam.PARAM_TYPE paramFilter, string recordName)
		{
			...
			for (int i = 0; i < paramSetGroups.Count; i++)
			{
				...
				if (GUILayout.Button(_guiContent_Modifier_ParamSetItem.Content, curGUIStyle, GUILayout.Width(scrollWidth - (5 + 25)), GUILayout.Height(20)))
				{
					//ParamSetGroup을 선택했다.
				...
				if (GUILayout.Button(imageVisible, apGUIStyleWrapper.I.None_LabelColor, GUILayout.Width(20), GUILayout.Height(20)))
				{
			...
			if(GUILayout.Button(_guiContent_Modifier_AddControlParameter.Content, GUILayout.Height(25)))
			{
			...
			//변경
			if (GUILayout.Button(_guiContent_CopyTextIcon.Content, GUILayout.Width(width / 2 - 4), GUILayout.Height(24)))
			{
			...
			//변경
			if (GUILayout.Button(_guiContent_PasteTextIcon.Content, GUILayout.Width(width / 2 - 4), GUILayout.Height(24)))
			{
				//ModMesh를 복사할 것인지, ModBone을 복사할 것인지 결정
				if (SubEditedParamSetGroup != null && ParamSetOfMod != null)
				{
			...
			if(Modifier.ModifierType == apModifierBase.MODIFIER_TYPE.TF)
			{
				...
				//변경
				if(GUILayout.Button(_guiContent_Modifier_RigExport.Content, GUILayout.Width((width / 2) - 4), GUILayout.Height(25)))
				{
					//Export Dialog 호출
				...
				//변경
				if(GUILayout.Button(_guiContent_Modifier_RigImport.Content, GUILayout.Width((width / 2) - 4), GUILayout.Height(25)))
				{
					//Import Dialog 호출
					if (SubEditedParamSetGroup != null && ParamSetOfMod != null)
					{
			...
			if (isGUI_TargetSelected || isGUI_TargetUnSelected)
			{
				if (isGUI_TargetSelected)
				{
					...
					if (isContain)
					{
						...
						if (GUILayout.Button(_guiContent_Modifier_RemoveFromKeys.Content, GUILayout.Width(width), GUILayout.Height(35)))
						{
					...
					else
					{
						...
						if (GUILayout.Button(_guiContent_Modifier_AddToKeys.Content, GUILayout.Width(width), GUILayout.Height(50)))
						{
		...
		private bool DrawModParamSetProperty(int index, apModifierParamSetGroup paramSetGroup, apModifierParamSet paramSet, int width, apModifierParamSet selectedParamSet, bool isUseParamSetWeight)
		{
			...
			if (isUseParamSetWeight)
			{
				...
				float paramSetWeight = EditorGUILayout.DelayedFloatField(paramSet._overlapWeight, apGUIStyleWrapper.I.TextField_MiddleLeft, GUILayout.Width(30), GUILayout.Height(20));
				...
				case apControlParam.TYPE.Int:
					{
						//GUIStyle guiStyle = new GUIStyle(GUI.skin.textField);
						//guiStyle.alignment = TextAnchor.MiddleLeft;
						int conInt = EditorGUILayout.DelayedIntField(paramSet._conSyncValue_Int, apGUIStyleWrapper.I.TextField_MiddleLeft, GUILayout.Width(compWidth), GUILayout.Height(20));
				...
				case apControlParam.TYPE.Float:
					{
						//GUIStyle guiStyle = new GUIStyle(GUI.skin.textField);
						//guiStyle.alignment = TextAnchor.MiddleLeft;
						float conFloat = EditorGUILayout.DelayedFloatField(paramSet._conSyncValue_Float, apGUIStyleWrapper.I.TextField_MiddleLeft, GUILayout.Width(compWidth), GUILayout.Height(20));
				...
				case apControlParam.TYPE.Vector2:
					{
						//GUIStyle guiStyle = new GUIStyle(GUI.skin.textField);
						//guiStyle.alignment = TextAnchor.MiddleLeft;
						float conVec2X = EditorGUILayout.DelayedFloatField(paramSet._conSyncValue_Vector2.x, apGUIStyleWrapper.I.TextField_MiddleLeft, GUILayout.Width(compWidth / 2 - 2), GUILayout.Height(20));
						float conVec2Y = EditorGUILayout.DelayedFloatField(paramSet._conSyncValue_Vector2.y, apGUIStyleWrapper.I.TextField_MiddleLeft, GUILayout.Width(compWidth / 2 - 2), GUILayout.Height(20));
			...
			if (isSelect)
			{
				...
				GUILayout.Box(Editor.GetUIWord(UIWORD.Selected), apGUIStyleWrapper.I.Box_UpperCenter_WhiteColor, GUILayout.Width(55), GUILayout.Height(20));//"Editing" -> Selected
				GUI.backgroundColor = prevColor;
			}
			else
			{
...
#region [미사용 코드] 이건 처리 역순 필요 없다. 동적 순서 배열이므로
		...
		private void DrawModifierPropertyGUI_Rigging(int width, int height, string recordName)
		{
			...
			if (targetMeshTransform == null)
			{
				...
				//"No Mesh is Selected"
				GUILayout.Box(Editor.GetUIWord(UIWORD.NoMeshIsSelected), apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(35));
			...
			else if (isContainInParamSetGroup)
			{
				...
				if (GUILayout.Button(_guiContent_Modifier_RemoveFromRigging.Content, GUILayout.Width(width), GUILayout.Height(30)))
				{
			...
			else
			{
				...
				if (GUILayout.Button(_guiContent_Modifier_AddToRigging.Content, GUILayout.Width(width), GUILayout.Height(30)))
				{
					Editor.Controller.AddModMesh_WithSubMeshOrSubMeshGroup();
			...
			GUILayout.Box(str_VertexInfo, apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(20));
			GUI.backgroundColor = prevColor;
			...
			GUILayout.Box(str_BoneInfo, apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width - 24), GUILayout.Height(20));
			GUI.backgroundColor = prevColor;
			...
			for (int i = 0; i < _riggingModifier_prevNumBoneWeights; i++)
			{
				if (i < _rigEdit_vertRigDataList.Count)
				{
					...
					{
						GUILayout.Box("", _guiStyle_RigIcon_Lock, GUILayout.Width(14), GUILayout.Height(14));//자물쇠 이미지
					}
					else
					{
						GUI.backgroundColor = vertRigData._bone._color;
						GUILayout.Box("", apEditorUtil.WhiteGUIStyle_Box, GUILayout.Width(14), GUILayout.Height(14));//일반 박스 이미지
						GUI.backgroundColor = prevColor;
					}
				...
				else
				{
					...
					if (GUILayout.Button(imgRemove, apGUIStyleWrapper.I.None_MiddleLeft_LabelColor, GUILayout.Width(20), GUILayout.Height(20)))
					{
						//Debug.LogError("TODO : Bone Remove From Rigging");
						//removeRigData = vertRigData;
						//Dummy
		...
		private void DrawModifierPropertyGUI_Physics(int width, int height)
		{
			...
			if (targetMeshTransform == null)
			{
				...
				if (isDummyTransform)
				{
					...
					//변경
					if (GUILayout.Button(_guiContent_Modifier_AddToPhysics.Content, GUILayout.Width(width), GUILayout.Height(25)))
					{
						//더미용 버튼
					}
				}
			...
			else if (isContainInParamSetGroup)
			{
				...
				if (!isDummyTransform)
				{
					...
					//변경
					if (GUILayout.Button(_guiContent_Modifier_RemoveFromPhysics.Content, GUILayout.Width(width), GUILayout.Height(30)))
					{
			...
			else
			{
				...
				if (!isDummyTransform)
				{
					...
					//변경
					if (GUILayout.Button(_guiContent_Modifier_AddToPhysics.Content, GUILayout.Width(width), GUILayout.Height(30)))
					{
						Editor.Controller.AddModMesh_WithSubMeshOrSubMeshGroup();
			...
			if (!isAnyTargetSelected || selectedVerts.Count == 0)
			{
				...
				GUI.backgroundColor = new Color(1.0f, 0.5f, 0.5f, 1.0f);
				//"No Vetex is Selected"
				GUILayout.Box(Editor.GetUIWord(UIWORD.NoVertexisSelected), apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(25));
			...
			else if (selectedVerts.Count == 1)
			{
				...
				GUILayout.Box(string.Format("[ {0} {1} ] : {2}", Editor.GetUIWord(UIWORD.Vertex), selectedVerts[0]._renderVert._vertex._index, selectedVerts[0]._modVertWeight._weight), 
								apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(25));
			...
			else
			{
				...
				//selectedVerts.Count + " Verts are Selected"
				GUILayout.Box(Editor.GetUIWordFormat(UIWORD.NumVertsareSelected, selectedVerts.Count), apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(25));
			...
			if (presetUnit != null)
			{
				...
				GUILayout.Box(_guiContent_Modifier_PhysicsSetting_NameIcon.Content, apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(30));
			...
			{
				//"Physical Material"
				GUILayout.Box(Editor.GetUIWord(UIWORD.PhysicalMaterial), apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(30));
			}
			...
			//변경
			EditorGUILayout.LabelField(_guiContent_Modifier_PhysicsSetting_Basic.Content, GUILayout.Height(labelHeight));
			...
			//변경
			EditorGUILayout.LabelField(_guiContent_Modifier_PhysicsSetting_Stretchiness.Content, GUILayout.Height(labelHeight));//"  Stretchiness"
			...
			//변경
			EditorGUILayout.LabelField(_guiContent_Modifier_PhysicsSetting_Inertia.Content, GUILayout.Width(labelWidth), GUILayout.Height(labelHeight));
			...
			//변경
			EditorGUILayout.LabelField(_guiContent_Modifier_PhysicsSetting_Restoring.Content, GUILayout.Width(labelWidth), GUILayout.Height(labelHeight));
			...
			//변경
			EditorGUILayout.LabelField(_guiContent_Modifier_PhysicsSetting_Viscosity.Content, GUILayout.Width(labelWidth), GUILayout.Height(labelHeight));
			...
			//변경
			EditorGUILayout.LabelField(_guiContent_Modifier_PhysicsSetting_Gravity.Content, GUILayout.Height(labelHeight));//"  Gravity"
			...
			else
			{
				...
				{
					GUI.backgroundColor = new Color(1.0f, 0.5f, 0.5f, 1.0f);
					GUILayout.Box(Editor.GetUIWord(UIWORD.NoControlParam), apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width - 34), GUILayout.Height(25));//"No ControlParam
			...
			//변경
			EditorGUILayout.LabelField(_guiContent_Modifier_PhysicsSetting_Wind.Content, GUILayout.Height(labelHeight));//"  Wind"
		...
		private void DrawEditor_Right2_Animation(int width, int height)
		{
			...
			EditorGUILayout.LabelField(_guiContent_Right_MeshGroup_AnimIcon.Content, GUILayout.Width(50), GUILayout.Height(50));
			...
			if (GUILayout.Button(_guiContent_Right_Animation_ExportImportAnim.Content, GUILayout.Height(22)))
			{
			...
			//변경
			EditorGUILayout.LabelField(curIconGUIContent.Content, GUILayout.Width(50), GUILayout.Height(50));
			...
			if (isAddingLayerOnce)
			{
				...
				_guiContent_Right_Animation_AllObjectToLayers.SetText(Editor.GetUIWordFormat(UIWORD.AllObjectToLayers, strTargetObject));
				_guiContent_Right_Animation_AllObjectToLayers.SetImage(addIconImage);

				if (GUILayout.Button(_guiContent_Right_Animation_AllObjectToLayers.Content, GUILayout.Height(30)))
				{
			...
			if (GUILayout.Button(_guiContent_Right_Animation_RemoveTimeline.Content, GUILayout.Height(24)))
			{
			...
			if (isGUI_TargetSelected)
			{
				...
				if (isAddableType)
				{
					...
					if (isAddable)
					{
						...
						if (GUILayout.Button(_guiContent_Right_Animation_AddTimelineLayerToEdit.Content, GUILayout.Height(35)))
						{
					...
					else
					{
						...
						if (GUILayout.Button(_guiContent_Right_Animation_RemoveTimelineLayer.Content, GUILayout.Height(24)))
						{
				...
				else
				{
					...
					else
					{
						...
						GUI.backgroundColor = new Color(0.5f, 0.5f, 0.5f, 1.0f);
						//"[" + targetObjectName + "]\nUnable to be Added"
						GUILayout.Box(Editor.GetUIWord(UIWORD.NotAbleToBeAdded), apGUIStyleWrapper.I.Box_MiddleCenter_BoxTextColor, GUILayout.Width(width), GUILayout.Height(35));
				...
				if (isGUI_SameLayer)
				{
					for (int i = 0; i < timelineLayers.Count; i++)
					{
						...
						EditorGUILayout.BeginHorizontal(GUILayout.Width(width), GUILayout.Height(20));
						GUILayout.Space(10);
						EditorGUILayout.LabelField(curLayer.DisplayName, apGUIStyleWrapper.I.Label_MiddleLeft, GUILayout.Width(compWidth), GUILayout.Height(20));
						...
						if (animTimelineLayer == curLayer)
						{
							...
							GUI.backgroundColor = new Color(0.2f, 0.2f, 0.2f, 1.0f);
							GUILayout.Box(Editor.GetUIWord(UIWORD.Selected), apGUIStyleWrapper.I.Box_UpperCenter_WhiteColor, GUILayout.Width(55), GUILayout.Height(20));//"Selected"
							GUI.backgroundColor = prevColor;
						}
						else
						{
